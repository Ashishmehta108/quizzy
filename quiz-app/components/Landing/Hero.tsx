          ...
          <AnimatedElement delay={0}>
            <Link href={"/dashboard"}>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-10">
                <Button className="text-sm bg-blue-500 hover:bg-blue-600   font-medium group rounded-full py-6  mb-8 inline-flex max-w-full items-center gap-2 rounded-full      font-medium  text-xs ring-1 shadow-lg shadow-sky-400/20 ring-sky-200/20 filter backdrop-blur-[1px] transition-colors  focus:outline-hidden sm:text-sm  dark:text-gray-100 dark:ring-sky-800/30 dark:shadow-sky-400/10 cursor-pointer">
                  Start Creating Now{" "}
                  <div className="bg-white w-6 h-6 rounded-full flex items-center justify-center">
                    <ArrowUpRight className="w-4 h-4 text-white group-hover:-translate-y-0.5 transition-transform group-hover:translate-x-0.5 stroke-blue-500" />
                  </div>
                </Button>
              </div>
            </Link>
