...
const testimonials = [
    {
        ...
        content: "This completely revolutionized my study routine. I can turn any textbook chapter into engaging quizzes in seconds.",
        avatar: "SC",
        rating: 5,
    },
    {
        ...
        company: "Google",
        content: "Perfect for onboarding and training. I upload technical docs and get instant knowledge assessments.",
        avatar: "DP",
        rating: 5,
    },
    {
        ...
        content: "My students are more engaged than ever. Creating personalized quizzes takes minutes instead of hours.",
        avatar: "MR",
        rating: 5,
    },
];
        ...
        >
            <div className="flex flex-row items-center gap-2">
                ...
                <div className="flex flex-col">
                    <figcaption className="text-sm font-medium text-zinc-900 dark:text-white">{name}</figcaption>
                    <p className="text-xs font-medium text-zinc-500 dark:text-zinc-400">{username}</p>
                </div>
            </div>
